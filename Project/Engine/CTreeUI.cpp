...
TreeNode* CTreeUI::AddNode(TreeNode* _Parent, const string& _Name, DWORD_PTR _Data)
{
	// 노드 생성 및 이름, ID 세팅
...
void CTreeUI::SetSelectedNode(TreeNode* _Node)
{
...
void CTreeUI::SetDragedNode(TreeNode* _Node)
{
	m_DragedNode = _Node;
}

void CTreeUI::SetDroppedNode(TreeNode* _Node)
{
...
void CTreeUI::PopupMenu(TreeNode* _Node)
{
