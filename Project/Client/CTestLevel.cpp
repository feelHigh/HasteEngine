...
//CLevel* CTestLevel::Initialize()
//{
//	// Material
//	Ptr<CMaterial> pMtrl = CAssetMgr::GetInstance()->FindAsset<CMaterial>(L"Std3DMtrl");
//
//	// Level 생성
...
//
//	Ptr<CTexture> pSkyBoxTex = CAssetMgr::GetInstance()->FindAsset<CTexture>(L"Texture\\Skybox\\Sky01.png");
//	pSkyBox->Skybox()->SetSkyboxTexture(pSkyBoxTex);
...
//
//	pPlayer->MeshRender()->GetMaterial()->SetTextureParameter(TEX_0, pTex);
